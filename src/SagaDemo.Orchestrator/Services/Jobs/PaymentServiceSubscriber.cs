...
public class PaymentServiceSubscriber : BackgroundService
{
    ...
    private readonly ILogger<PaymentServiceSubscriber> _logger;

    public PaymentServiceSubscriber(
        IEventProcessor eventProcessor,
        RabbitMqSettings rabbitMqSettings,
        ILogger<PaymentServiceSubscriber> logger)
    {
    ...
    public void InitializeRabbitMq()
    {
        ...
        _logger.LogInformation("Successfully connected to RabbitMQ payment service queue");
    }
